...
import rosePetalsCorner from "@/assets/rose-petals-corner.png";
...
const FloralDecor = () => (
  <>
    <img
      src={rosePetals}
      alt=""
      className="absolute top-0 left-0 w-64 h-64 opacity-30 -translate-x-10 -translate-y-10 rotate-12 pointer-events-none"
      loading="lazy"
      width={1024}
      height={1024}
    />
    <img
      src={rosePetalsCorner}
      alt=""
      className="absolute bottom-0 right-0 w-56 h-56 opacity-25 translate-x-8 translate-y-8 rotate-180 pointer-events-none"
      loading="lazy"
      width={512}
      height={512}
    />
    <img
      src={rosePetalsCorner}
      alt=""
      className="absolute top-20 right-0 w-32 h-32 opacity-20 translate-x-4 pointer-events-none"
      loading="lazy"
      width={512}
      height={512}
    />
    <img
      src={rosePetals}
      alt=""
      className="absolute bottom-10 left-0 w-40 h-40 opacity-20 -translate-x-6 -rotate-45 pointer-events-none"
      loading="lazy"
      width={1024}
      height={1024}
    />
